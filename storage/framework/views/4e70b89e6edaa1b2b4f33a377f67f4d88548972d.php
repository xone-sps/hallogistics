 		...
 		<div class="content">
 						...
 						<div class="modal-content">
 							...
 							<div class="modal-body">
 								...
 								<div class="form-group">
 									...
 									<input type="text" class="form-control" placeholder="Price" name="box_price" value="<?php echo e($package_over->box_price); ?>">
 								</div>
 								<div class="mb-3">
 									<div class="form-group">
 										<label for="exampleFormControlTextarea2">Description</label>
 			...
 			<div class="card">
 				<div class="card-header">
 					<h3 class="card-title">Package ນີ້ແມ່ນຄິດໄລ່ລາຄາຂ້າມພາກ</h3>
 				</div>
 					...
 					<table class="table table-striped projects">
 						...
 						<tbody>
 							...
 							<tr>
 								...
 								<td>
 									<p><?php echo e(strip_tags($package_over->description)); ?></p>
 								</td>
 								<td>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp new\htdocs\hallogistics\laravel\resources\views/Default/package_over.blade.php ENDPATH**/ ?>
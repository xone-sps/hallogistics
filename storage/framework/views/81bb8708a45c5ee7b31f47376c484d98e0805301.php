              ...
              <div class="card-footer">
                <form action="<?php echo e(route('news.search')); ?>" method="get">
                  <div class="input-group">
                    <input type="text" name="search" placeholder="Type Message ..." class="form-control">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp new\htdocs\hallogistics\laravel\resources\views/Default/News.blade.php ENDPATH**/ ?>
 						...
 						<div class="modal-content">
 							...
 							<div class="modal-body">
 								...
 								<div class="form-group">
 									...
 									<input type="text" class="form-control" placeholder="Price" name="box_price" value="<?php echo e($package->box_price); ?>" required>
 								</div>
 								<div class="mb-3">
 									<label for="exampleInputEmail1">Description</label>
 						...
 						<table class="table table-striped projects">
 							...
 							<tbody>
 								...
 								<tr>
 									...
 									<td>
 										<span><?php echo e($package->created_at); ?></span>
 									</td>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp new\htdocs\hallogisticscli\laravel\resources\views/Default/package.blade.php ENDPATH**/ ?>